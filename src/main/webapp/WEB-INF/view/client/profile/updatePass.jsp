                        ...
                        <section class="section profile">
                            <div class="row">
                                ...
                                <div class="col-xl-12"
                                    ...
                                    <form:form action="/updatePassF" method="post" modelAttribute="updatePass">
                                        <!-- Email input -->
                                        <div data-mdb-input-init class="form-outline mb-4">
                                            <form:input type="text" id="form2Example1" class="form-control"
                                                style="width: 169%;" path="currentPass" />
                                            <div>
                                                <label class="form-label" for="form2Example1">Mật khẩu hiện tại </label>
                                                <p><span style="color: red;">${errCurrent}</span></p>
                                            </div>
                                        </div>
                                        <div data-mdb-input-init class="form-outline mb-4">
                                            <form:input type="text" id="form2Example1" class="form-control"
                                                style="width: 169%;" path="newPass" />
                                            <label class="form-label" for="form2Example1">Mật khẩu mới</label>
                                        </div>
                                        <div data-mdb-input-init class="form-outline mb-4">
                                            <form:input type="text" id="form2Example1" class="form-control"
                                                style="width: 169%;" path="rePass" />
                                            <label class="form-label" for="form2Example1">Xác nhận mật khẩu</label>
                                            <p><span style="color: red;">${errPass}</span></p>
                                        </div>
