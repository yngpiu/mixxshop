                        ...
                        <div class="container topbar bg-primary d-none d-lg-block">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="top-link pe-2">
                                    ...
                                    <a href="#" class="text-white"><small class="text-white ms-2">Buy Like You
                                            Want</small></a>
                                </div>
                            </div>
                        </div>
                        <div class="container px-0">
                            <nav class="navbar navbar-light bg-white navbar-expand-xl">
                                <a href="/" class="navbar-brand">
                                    <h1 class="text-primary display-6">Mixxshop</h1>
                                </a>
            ...
            <div class="modal-content rounded-0">
                ...
                <div class="modal-body d-flex align-items-center">
                    ...
                    <div class="container-fluid page-header py-5">
                        <h1 class="text-center text-white display-6" style="color: red">Detail Product</h1>
                        ...
                        <div class="container py-5">
                                ...
                                <div class="col-lg-8 col-xl-9">
                                    <div class="row g-4">
                                                ...
                                                <a href="#">
                                                    <c:choose>
                                                        <c:when test="${empty product.image}">
                                                            <img src="https://dummyimage.com/500x500/000/fff&text=NoImage"
                                                                class="img-fluid rounded" alt="Default Product Image">
                                                        </c:when>
                                                        <c:otherwise>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <p class="mb-4">${product.shortDes}.</p>

                                            <form:form action="/add-product-to-card/${product.id}" method="post"
                                                ...
                                                <button type="submit" class="fa fa-shopping-bag me-2 text-primary"
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="tab-content mb-5">
                                                ...
                                                <div class="tab-pane" id="nav-mission" role="tabpanel"
                                                    ...
                                                    <div class="d-flex">
                                                        <img src="/images/product/avatar.jpg"
                            ...
                            <div class="d-flex align-items-center justify-content-start">
                                <div class="rounded" style="width: 100px; height: 100px;">
                                    <img src="/images/product/featur-1.jpg" class="img-fluid rounded" alt="Image">
                                </div>
                                <div>
                            ...
                            <div class="d-flex align-items-center justify-content-start">
                                <div class="rounded" style="width: 100px; height: 100px;">
                                    <img src="/images/product/featur-2.jpg" class="img-fluid rounded" alt="">
                                </div>
                                <div>
                                    <h6 class="mb-2">Big Banana</h6>
                                    <div class="d-flex mb-2">
                            ...
                            <div class="d-flex align-items-center justify-content-start">
                                <div class="rounded" style="width: 100px; height: 100px;">
                                    <img src="/images/product/featur-3.jpg" class="img-fluid rounded" alt="">
                                </div>
                                <div>
                                    <h6 class="mb-2">Big Banana</h6>
                                    <div class="d-flex mb-2">
                            ...
                            <div class="d-flex align-items-center justify-content-start">
                                <div class="rounded me-4" style="width: 100px; height: 100px;">
                                    <img src="/images/product/vegetable-item-4.jpg" class="img-fluid rounded" alt="">
                                </div>
                                <div>
                                    <h6 class="mb-2">Big Banana</h6>
                                    <div class="d-flex mb-2">
                            ...
                            <div class="d-flex align-items-center justify-content-start">
                                <div class="rounded me-4" style="width: 100px; height: 100px;">
                                    <img src="/images/product/vegetable-item-5.jpg" class="img-fluid rounded" alt="">
                                </div>
                                <div>
                                    <h6 class="mb-2">Big Banana</h6>
                                    <div class="d-flex mb-2">
                            ...
                            <div class="d-flex align-items-center justify-content-start">
                                <div class="rounded me-4" style="width: 100px; height: 100px;">
                                    <img src="/images/product/vegetable-item-6.jpg" class="img-fluid rounded" alt="">
                                </div>
                                <div>
                                    <h6 class="mb-2">Big Banana</h6>
                                    <div class="d-flex mb-2">
                            ...
                            <div class="position-relative">
                                <img src="/images/product/banner-fruits.jpg" class="img-fluid w-100 rounded" alt="">
                ...
                <div class="owl-carousel vegetable-carousel justify-content-center">
                    <div class="border border-primary rounded position-relative vesitable-item">
                        <div class="vesitable-img">
                            <img src="/images/product/vegetable-item-6.jpg" class="img-fluid w-100 rounded-top" alt="">
                        </div>
                    ...
                    <div class="border border-primary rounded position-relative vesitable-item">
                        <div class="vesitable-img">
                            <img src="/images/product/vegetable-item-1.jpg" class="img-fluid w-100 rounded-top" alt="">
                        </div>
                        <div class="text-white bg-primary px-3 py-1 rounded position-absolute"
                            style="top: 10px; right: 10px;">Vegetable</div>
                        <div class="p-4 pb-0 rounded-bottom">
                    ...
                    <div class="border border-primary rounded position-relative vesitable-item">
                        <div class="vesitable-img">
                            <img src="/images/product/vegetable-item-3.png" class="img-fluid w-100 rounded-top bg-light"
                                alt="">
                        </div>
                        <div class="text-white bg-primary px-3 py-1 rounded position-absolute"
                            style="top: 10px; right: 10px;">Vegetable</div>
                    ...
                    <div class="border border-primary rounded position-relative vesitable-item">
                        <div class="vesitable-img">
                            <img src="/images/product/vegetable-item-4.jpg" class="img-fluid w-100 rounded-top" alt="">
                        </div>
                        <div class="text-white bg-primary px-3 py-1 rounded position-absolute"
                            style="top: 10px; right: 10px;">Vegetable</div>
                        <div class="p-4 pb-0 rounded-bottom">
                    ...
                    <div class="border border-primary rounded position-relative vesitable-item">
                        <div class="vesitable-img">
                            <img src="/images/product/vegetable-item-5.jpg" class="img-fluid w-100 rounded-top" alt="">
                        </div>
                        <div class="text-white bg-primary px-3 py-1 rounded position-absolute"
                            style="top: 10px; right: 10px;">Vegetable</div>
                        <div class="p-4 pb-0 rounded-bottom">
