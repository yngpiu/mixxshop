                                            ...
                                            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                                                <form:form action="/admin/order/del/finish" method="post"
                                                    ...
                                                    <div class="alert alert-success" role="alert">
                                                        ...
                                                        <p>Bạn có muốn xóa đơn hàng có Id: <span style="color: red">
                                                                ${delO.id} </span> của khách hàng:
                                                            <span style="color: red">${delO.receiverName}</span>
                                                        </p>
                                                        <form:input type="text" value="${delO.id}"
                                                            style="display: none;" path="id" />
                                                        <p>Nếu bạn xóa , thì không thể khôi phục , Bạn đồng ý không ?
                                                        </p>
                                                        <hr>
                                                        <div style="display: flex; gap: 17px">
                                                            <button type="submit" class="btn btn-danger">Đồng ý
                                                            </button>
                                                        </div>
                                                    </div>
