                                    ...
                                    <div class="container-fluid h-custom">
                                        <div class="row d-flex justify-content-center align-items-center h-100">
                                            <div class="col-md-9 col-lg-6 col-xl-5">
                                                <img src="/images/avatar/editUser.png" class="img-fluid"
                                                    alt="Sample image">
                                            </div>
                                            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                                                <form:form method="post" action="/edit/user/finish"
                                                    modelAttribute="user">
                                                    ...
                                                    <div data-mdb-input-init class="form-outline mb-4"
                                                        ...
                                                        <form:input type="text" id="form3Example3"
                                                            ...
                                                            placeholder="Enter a valid email address" value="${user.id}"
                                                            path="id" />
                                                    ...
                                                    <div data-mdb-input-init class="form-outline mb-3">
                                                        <form:input type="text" id="form3Example4"
                                                            class="form-control form-control-lg"
                                                            placeholder="Enter password" value="${user.fullname}"
                                                            path="fullname" />
                                                        <label class="form-label" for="form3Example4">Tên người
                                                            dùng</label>
                                                    </div>
                                                    ...
                                                    <div style="display: flex; justify-content: space-between;">
                                                        <div data-mdb-input-init class="form-outline mb-3">
                                                            ...
                                                            <label class="form-label" for="form3Example4">Địa
                                                                chỉ</label>
                                                        </div>
                                                        ...
                                                        <div data-mdb-input-init class="form-outline mb-3">
                                                            ...
                                                            <label class="form-label" for="form3Example4"
                                                                style="margin-left: 5%;">Số điện thoại</label>
                                                        </div>
