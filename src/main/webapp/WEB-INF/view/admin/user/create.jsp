                        ...
                        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                            <div class="sb-sidenav-menu">
                                <div class="nav">
                                    ...
                                    <a class="nav-link" href="/table/user" id="as" style="background-color: brown;">
                                                ...
                                                <form:form method="post" action="/create/user/finish"
                                                    ...
                                                    <div style="display: flex;">
                                                        ...
                                                        <div data-mdb-input-init class="form-outline mb-3">
                                                            <form:input type="password" id="form3Example4"
                                                                ...
                                                                style="width: 93%;" />
                                                            <label class="form-label" for="form3Example4">Mật
                                                                khẩu</label>
                                                        </div>
                                                        ...
                                                        <div data-mdb-input-init class="form-outline mb-3">
                                                            ...
                                                            <label class="form-label" for="form3Example4"
                                                                style="margin-left: 7%;">Tên người dùng</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div style="display: flex;">
                                                        ...
                                                        <div data-mdb-input-init class="form-outline mb-3">
                                                            <form:input type="text" id="form3Example4"
                                                                ...
                                                                style="width: 93%; margin-left: 7%;" />
                                                            <label class="form-label" for="form3Example4"
                                                                style="margin-left: 7%;">Số điện thoại</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="text-center text-lg-start mt-4 pt-2">
                                                        <button type="submit" data-mdb-button-init data-mdb-ripple-init
                                                            ...
                                                            style="padding-left: 2.5rem; padding-right: 2.5rem;">Tạo tài
                                                            khoản</button>
                                                    </div>
